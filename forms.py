...
class AdvancedFilterForm(CleanWhiteSpacesMixin, forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if model_admin:
            ...
            appConfig = apps.get_app_config(instance._meta.app_label) #1.9?
            self._model = appConfig.get_model(*instance.model.split('.')) #1.9?
            
            #self._model = get_model(*instance.model.split('.')) #<1.9?
